        ...
        <div className="row d-flex justify-content-center align-items-center mt-lg-5">
            ...
            <h3> {newUser ? "Create an account" : "Login"}</h3> 
             ...
             <form onSubmit={handleSubmit}>
              <div className="my-3">
                ...
                <div className="my-2">
                  <input type="submit" className="form-control bg-info text-white py-2" value={newUser ? "Create an account" : "Login"} />
                </div>
             </form>
         ...
         <div className="div text-center mt-2">
          ...
          <div className="my-3 d-flex justify-content-center">
                <button className="btn btn-outline-primary mx-2 rounded-pill my-2 text-center" onClick={handelGoogleSignIn}><FontAwesomeIcon icon={faGoogle} /> Google</button>
          </div>
         </div>
        </div>
